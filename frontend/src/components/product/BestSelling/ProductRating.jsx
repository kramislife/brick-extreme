  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: "11/19/2024",
      content: "I bought the jack-o-lantern last year, and this year I bought the skull and gravestones. The whole spooky collection makes my weird heart so happy! They were quick, easy builds, and I hope to see more builds in this collection."
    },
    {
      id: 2,
      author: "Sarah Smith",
      rating: 5,
      date: "12/01/2024",
      content: "Absolutely love these decorative pieces! The attention to detail is incredible, and they look even better in person. Assembly was straightforward, and the quality exceeded my expectations. Can't wait to add more to my collection!"
    }
  ]

  // Calculate ratings dynamically based on reviews
