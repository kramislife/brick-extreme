  ...
  return (
    ...
    >
      ...
      <motion.div variants={contentVariants} className="text-center mb-16">
        <h1 className="text-4xl font-bold mb-4 text-brand">Explore the Infinite. Build Your Legacy.</h1>
        <p className="text-muted-foreground text-lg">From the heart of Lehi, Utah</p>
      </motion.div>
        ...
        <Card className="mb-12 bg-brand/5 shadow-lg">
          <CardContent className="p-8">
            <p className="text-lg leading-relaxed text-foreground">
              Brick Extreme was born out of a passion for Lego and a desire to push the boundaries 
              of custom brick building. Founded in 2024 by Mark and Derik Storey, our team of 
              talented Brick Artisans is dedicated to crafting extraordinary Lego creations 
        ...
        <motion.div variants={contentVariants}>
          <Card className="h-full hover:bg-brand/10 transition-colors shadow-lg">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground">Pushing the boundaries of custom brick building</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        <motion.div variants={contentVariants}>
          <Card className="h-full hover:bg-brand/10 transition-colors shadow-lg">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground">Dedicated to crafting extraordinary creations</p>
            </CardContent>
          </Card>
        </motion.div>
        ...
        <motion.div variants={contentVariants}>
          <Card className="h-full hover:bg-brand/10 transition-colors shadow-lg">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground">Building memories that last a lifetime</p>
            </CardContent>
          </Card>
        </motion.div>
      </motion.div>
      ...
      <motion.div variants={contentVariants} className="text-center">
        <h2 className="text-2xl font-bold mb-6 text-brand">Defy the Limits. Create Your Next Fig!</h2>
        <Button 
          size="lg" 
